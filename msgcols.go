...
func (fh *FunHouse) GetColumns(ctx context.Context, appr Appender) (err error) {
...
func (fh *FunHouse) PutColumns(ctx context.Context, mcs *entity.MsgCols) (err error) {
